      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full text-slate-600 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 text-slate-600 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
          ...
          <div className="grid grid-cols-2 gap-3 text-slate-400 ">
            <button className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors hover:text-slate-600 ">
