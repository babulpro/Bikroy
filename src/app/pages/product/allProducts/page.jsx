    ...
    <div className="min-h-screen py-12 bg-gradient-to-br from-blue-50 to-gray-100">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="max-w-xl mx-auto mb-6">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-12 text-gray-800 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
        ...
        <div className="mb-4 lg:hidden">
          ...
          >
            <span className="text-gray-700">Filters & Sorting</span>
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className={`lg:w-72 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="sticky p-5 bg-white rounded-lg shadow-lg top-24">
              ...
              <div className="mb-5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-1/2 px-3 py-2 text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <input
                    type="number"
                    placeholder="Max"
              ...
              {/* Active Filters */}
              {(filters.categoryId || filters.condition || filters.minPrice || filters.maxPrice) && (
                <div className="pt-4 mt-2 border-t border-gray-200">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {filters.categoryId && categories.find(c => c.id === filters.categoryId) && (
                      <span className="inline-flex items-center px-2 py-1 text-xs text-blue-700 bg-blue-100 rounded">
                        {categories.find(c => c.id === filters.categoryId).name}
                        <button onClick={() => handleFilterChange('categoryId', '')} className="ml-1 hover:text-blue-900">×</button>
                      </span>
                    )}
                    {filters.condition && (
                      <span className="inline-flex items-center px-2 py-1 text-xs text-blue-700 bg-blue-100 rounded">
                        {filters.condition}
                        <button onClick={() => handleFilterChange('condition', '')} className="ml-1 hover:text-blue-900">×</button>
                      </span>
                    )}
                  </div>
                </div>
