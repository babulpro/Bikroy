      ...
      {isDropdownOpen && (
        <div className="absolute right-0 z-50 w-64 mt-2 bg-white rounded-lg shadow-xl">
          ...
          <div className="py-2">
            ...
            <Link href="/pages/user/product" onClick={() => setIsDropdownOpen(false)} className="flex items-center px-4 py-2 text-gray-700 transition-colors hover:bg-blue-50 hover:text-blue-600">
              <svg className="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
