// src/app/pages/product/category/[id]/components/FilterBar.jsx
export default function FilterBar({ showFilters, onToggleFilters, sortBy, onSortChange, viewMode, onViewModeChange }) {
  return (
