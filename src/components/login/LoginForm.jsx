// src/components/login/login/LoginForm.jsx
'use client';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.status === 'success') {
        ...
        setErrors({ submit: data.msg || 'Invalid email or password' });
      }
    } catch (error) {
        ...
        <div className="p-6 bg-white rounded-lg shadow-xl md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/pages/forgot-password" className="text-sm text-blue-600 hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/pages/user/register" className="font-semibold text-blue-600 hover:underline">
                Create an account
              </Link>
            </p>
          </div>
          ...
          {redirectUrl !== '/' && (
            <div className="p-3 mt-4 border border-blue-200 rounded-lg bg-blue-50">
              <p className="text-xs text-blue-700">
                🔐 You'll be redirected to the page you were trying to access after login.
              </p>
            </div>
          )}
        </div>
